...
function exportReaderData() {
  const data = { app: 'Manga HQ Reader', version: CONFIG.appVersion || '2.2.1', exportedAt: new Date().toISOString(), favorites: [...favorites], progress, prefs, bookmarks, displayPrefs, itemReaderPrefs };
