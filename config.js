...
// Para descobrir e sincronizar novos arquivos via Google Drive API, informe a chave
...
window.MHQR_CONFIG = {
  ...
  externalSources: [
    {
      name: 'Acervo Marvel — GitHub',
      siteUrl: 'https://github.com/jogoiarexx-blip/Manga-HQ-acervo-Marvel',
      note: 'Acervo Marvel integrado ao catálogo do Manga HQ Reader, incluindo Wolverine Supremo.'
    },
    {
